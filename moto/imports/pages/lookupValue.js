...
// Declare template
let indexTmpl = Template.Moto_lookupValue,
    optionsTmpl = Template.Moto_lookupValueOptions,
    formTmpl = Template.Moto_lookupValueForm;
...
formTmpl.onCreated(function () {
    this.autorun(()=> {
        ...
        if (currentData) {
            this.subscribe('moto.lookupValueById', currentData.lookupValueId);
        }
    });
});
...
AutoForm.addHooks(['Moto_lookupValueForm'], hooksObject);
