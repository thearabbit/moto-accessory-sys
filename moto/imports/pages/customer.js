...
// Declare template
let indexTmpl = Template.Moto_customer,
    contactTmpl = Template.Moto_customerContact,
    formTmpl = Template.Moto_customerForm,
    showTmpl = Template.Moto_customerShow;
...
formTmpl.onCreated(function () {
    this.autorun(()=> {
        ...
        if (currentData) {
            this.subscribe('moto.customerById', currentData.customerId);
        }
    });
});
...
AutoForm.addHooks(['Moto_customerForm'], hooksObject);
