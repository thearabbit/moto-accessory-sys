...
// Method
import {activeOrderReport} from '../../common/methods/reports/activeOrder.js';

// Schema
import {ActiveOrderSchema} from '../../common/collections/reports/activeOrder.js';

// Page
import './activeOrder.html';

// Declare template
let indexTmpl = Template.Moto_activeOrderReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            activeOrderReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('Moto_activeOrderReport', hooksObject);
