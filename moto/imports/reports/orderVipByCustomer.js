...
// Method
import {orderVipByCustomerReport} from '../../common/methods/reports/orderVipByCustomer.js';

// Schema
import {OrderVipByCustomerSchema} from '../../common/collections/reports/orderVipByCustomer.js';

// Page
import './orderVipByCustomer.html';

// Declare template
let indexTmpl = Template.Moto_orderVipByCustomerReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            orderVipByCustomerReport.callPromise(formDataState.get())
                .then((result)=> {
...
indexTmpl.helpers({
    schema(){
        return OrderVipByCustomerSchema;
    },
    rptInit(){
...
AutoForm.addHooks('Moto_orderVipByCustomerReport', hooksObject);
