...
// Method
import {orderByCustomerReport} from '../../common/methods/reports/orderByCustomer.js';

// Schema
import {OrderByCustomerSchema} from '../../common/collections/reports/orderByCustomer.js';

// Page
import './orderByCustomer.html';

// Declare template
let indexTmpl = Template.Moto_orderByCustomerReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            orderByCustomerReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('Moto_orderByCustomerReport', hooksObject);
