...
// Method
import {activeOrderVipReport} from '../../common/methods/reports/activeOrderVip.js';

// Schema
import {ActiveOrderVipSchema} from '../../common/collections/reports/activeOrderVip.js';

// Page
import './activeOrderVip.html';

// Declare template
let indexTmpl = Template.Moto_activeOrderVipReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            activeOrderVipReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('Moto_activeOrderVipReport', hooksObject);
