...
// Method
import {orderVipReport} from '../../common/methods/reports/orderVip.js';

// Schema
import {OrderVipSchema} from '../../common/collections/reports/orderVip.js';

// Page
import './orderVip.html';

// Declare template
let indexTmpl = Template.Moto_orderVipReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            orderVipReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('Moto_orderVipReport', hooksObject);
